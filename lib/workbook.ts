...
export async function exportProductTemplate(categories: string[] = [], modes: string[] = []) {
  ...
  guide.addRows([
    ...
    ['必填字段','产品货号、产品模式、排版分类、产品分类；产品名称和文件路径均可留空。产品名称填写后不能与其他商品重复，产品货号必须唯一。'],
    ['排版分类','只能填写“设计排版”或“非设计排版”，必须二选一。所有商品的文件路径均为选填。'],
    ['是否需要打印','只能填写“是”或“否”；新商品不填写时按“否”处理。只要填写了完整的源路径和目标路径，就会按是否打印导出到对应 CSV。'],
